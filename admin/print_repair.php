...
if(strlen($_SESSION['alogin'])==0){	
    ...
    class MYPDF extends TCPDF {
        ...
        if ($this->page == 1) {  // hanya page pertama
    ...
    $html = '<br><br><h3 style="text-align:center; margin-top:45px;">Repair Report</h3>
    <table border="1" cellpadding="5" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td>'.htmlentities($row['brandname']).'</td>

            <td><b>No Model</b></td>
            <td>'.htmlentities($row['modelNo']).'</td>
